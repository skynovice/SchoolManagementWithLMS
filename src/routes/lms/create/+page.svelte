  ...
  async function saveTopic() {
    ...
    try {
      ...
      for (let i = 0; i < parts.length; i++) {
        ...
        // 3. Create resources for this part
      ...
      alert('สร้างเนื้อหาการเรียนสำเร็จ!');
      goto(`/lms/topic/${topicData.id}`);
...
<div class="max-w-4xl mx-auto">
  ...
  <div class="flex items-center justify-between mb-8">
    <div class="flex items-center gap-4">
      ...
      <div>
        <h1 class="text-3xl font-bold text-gray-800">สร้างเนื้อหาการเรียนใหม่</h1>
        <p class="text-gray-600">สร้างหัวข้อการเรียนพร้อมเนื้อหา ทรัพยากร และแบบทดสอบ</p>
      </div>
    </div>
    <a 
      href="/lms" 
  ...
  {:else}
    <form on:submit|preventDefault={saveTopic} class="space-y-8">
      <!-- Basic Information -->
      ...
      <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-6">
          ...
          <button
            type="button"
            on:click={addPart}
            class="flex items-center gap-2 px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-lg font-medium transition-colors"
          >
            <span>➕</span>
            <span>เพิ่มส่วน</span>
          </button>
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all resize-none"
                ></textarea>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all resize-none font-mono text-sm"
                ></textarea>
      ...
      <div class="flex justify-end gap-4">
        ...
        <button
          type="submit"
          disabled={saving}
          class="px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-xl font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
          {#if saving}
